...
(cl:defclass <ObstPointCloud> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector cluster-msg:PointXYZI)
   :initform (cl:make-array 0 :element-type 'cluster-msg:PointXYZI :initial-element (cl:make-instance 'cluster-msg:PointXYZI))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObstPointCloud>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstPointCloud)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cluster-msg:<ObstPointCloud> is deprecated: use cluster-msg:ObstPointCloud instead.")))
...
(cl:defmethod points-val ((m <ObstPointCloud>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cluster-msg:points-val is deprecated.  Use cluster-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObstPointCloud>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cluster-msg:PointXYZI))
