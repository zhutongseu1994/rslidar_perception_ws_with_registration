...
(cl:defmethod cl:initialize-instance :after ((m <Heart>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Heart)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cluster-msg:<Heart> is deprecated: use cluster-msg:Heart instead.")))

(cl:ensure-generic-function 'process_id-val :lambda-list '(m))
(cl:defmethod process_id-val ((m <Heart>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cluster-msg:process_id-val is deprecated.  Use cluster-msg:process_id instead.")
  (process_id m))

(cl:ensure-generic-function 'process_name-val :lambda-list '(m))
(cl:defmethod process_name-val ((m <Heart>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cluster-msg:process_name-val is deprecated.  Use cluster-msg:process_name instead.")
  (process_name m))
