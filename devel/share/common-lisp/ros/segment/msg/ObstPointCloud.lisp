...
(cl:defclass <ObstPointCloud> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector segment-msg:PointXYZI)
   :initform (cl:make-array 0 :element-type 'segment-msg:PointXYZI :initial-element (cl:make-instance 'segment-msg:PointXYZI))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObstPointCloud>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstPointCloud)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segment-msg:<ObstPointCloud> is deprecated: use segment-msg:ObstPointCloud instead.")))
...
(cl:defmethod points-val ((m <ObstPointCloud>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:points-val is deprecated.  Use segment-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObstPointCloud>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'segment-msg:PointXYZI))
