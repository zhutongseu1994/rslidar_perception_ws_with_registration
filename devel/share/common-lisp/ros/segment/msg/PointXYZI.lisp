...
(cl:defmethod cl:initialize-instance :after ((m <PointXYZI>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointXYZI)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segment-msg:<PointXYZI> is deprecated: use segment-msg:PointXYZI instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <PointXYZI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:x-val is deprecated.  Use segment-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <PointXYZI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:y-val is deprecated.  Use segment-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <PointXYZI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:z-val is deprecated.  Use segment-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <PointXYZI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:intensity-val is deprecated.  Use segment-msg:intensity instead.")
  (intensity m))
