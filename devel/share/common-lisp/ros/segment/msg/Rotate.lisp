...
(cl:defmethod cl:initialize-instance :after ((m <Rotate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rotate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segment-msg:<Rotate> is deprecated: use segment-msg:Rotate instead.")))
...
(cl:defmethod w-val ((m <Rotate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:w-val is deprecated.  Use segment-msg:w instead.")
  (w m))
