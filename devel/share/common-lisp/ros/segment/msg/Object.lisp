...
(cl:defclass <Object> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (center
    :reader center
    :initarg :center
    :type segment-msg:Center
    :initform (cl:make-instance 'segment-msg:Center))
   (width
    :reader width
    :initarg :width
    :type cl:float
   ...
   (rotate
    :reader rotate
    :initarg :rotate
    :type segment-msg:Rotate
    :initform (cl:make-instance 'segment-msg:Rotate)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Object>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Object)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segment-msg:<Object> is deprecated: use segment-msg:Object instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:id-val is deprecated.  Use segment-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:center-val is deprecated.  Use segment-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:width-val is deprecated.  Use segment-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:height-val is deprecated.  Use segment-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:depth-val is deprecated.  Use segment-msg:depth instead.")
  (depth m))

(cl:ensure-generic-function 'speedx-val :lambda-list '(m))
(cl:defmethod speedx-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:speedx-val is deprecated.  Use segment-msg:speedx instead.")
  (speedx m))

(cl:ensure-generic-function 'speedy-val :lambda-list '(m))
(cl:defmethod speedy-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:speedy-val is deprecated.  Use segment-msg:speedy instead.")
  (speedy m))

(cl:ensure-generic-function 'k-val :lambda-list '(m))
(cl:defmethod k-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:k-val is deprecated.  Use segment-msg:k instead.")
  (k m))

(cl:ensure-generic-function 'rotate-val :lambda-list '(m))
(cl:defmethod rotate-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:rotate-val is deprecated.  Use segment-msg:rotate instead.")
  (rotate m))
