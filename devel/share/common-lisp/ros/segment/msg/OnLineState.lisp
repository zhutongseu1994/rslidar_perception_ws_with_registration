...
(cl:defmethod cl:initialize-instance :after ((m <OnLineState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OnLineState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segment-msg:<OnLineState> is deprecated: use segment-msg:OnLineState instead.")))

(cl:ensure-generic-function 'decv_id-val :lambda-list '(m))
(cl:defmethod decv_id-val ((m <OnLineState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:decv_id-val is deprecated.  Use segment-msg:decv_id instead.")
  (decv_id m))

(cl:ensure-generic-function 'decv_state-val :lambda-list '(m))
(cl:defmethod decv_state-val ((m <OnLineState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segment-msg:decv_state-val is deprecated.  Use segment-msg:decv_state instead.")
  (decv_state m))
