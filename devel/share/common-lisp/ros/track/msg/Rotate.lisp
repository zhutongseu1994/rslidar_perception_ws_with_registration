...
(cl:defmethod cl:initialize-instance :after ((m <Rotate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rotate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name track-msg:<Rotate> is deprecated: use track-msg:Rotate instead.")))
...
(cl:defmethod w-val ((m <Rotate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader track-msg:w-val is deprecated.  Use track-msg:w instead.")
  (w m))
