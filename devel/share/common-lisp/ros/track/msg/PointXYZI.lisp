...
(cl:defmethod cl:initialize-instance :after ((m <PointXYZI>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointXYZI)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name track-msg:<PointXYZI> is deprecated: use track-msg:PointXYZI instead.")))
...
(cl:defmethod z-val ((m <PointXYZI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader track-msg:z-val is deprecated.  Use track-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <PointXYZI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader track-msg:intensity-val is deprecated.  Use track-msg:intensity instead.")
  (intensity m))
