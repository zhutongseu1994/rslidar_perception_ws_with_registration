...
(cl:defmethod cl:initialize-instance :after ((m <Center>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Center)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name track-msg:<Center> is deprecated: use track-msg:Center instead.")))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <Center>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader track-msg:pos-val is deprecated.  Use track-msg:pos instead.")
  (pos m))
