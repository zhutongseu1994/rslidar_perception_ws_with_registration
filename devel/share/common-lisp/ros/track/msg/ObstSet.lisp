...
(cl:defclass <ObstSet> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obsts
    :reader obsts
    :initarg :obsts
    :type (cl:vector track-msg:ObstPointCloud)
   :initform (cl:make-array 0 :element-type 'track-msg:ObstPointCloud :initial-element (cl:make-instance 'track-msg:ObstPointCloud))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObstSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name track-msg:<ObstSet> is deprecated: use track-msg:ObstSet instead.")))
...
(cl:defmethod obsts-val ((m <ObstSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader track-msg:obsts-val is deprecated.  Use track-msg:obsts instead.")
  (obsts m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObstSet>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obsts)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'track-msg:ObstPointCloud))
